...
wp option update blogdescription "Blog outdoorowy — trasy, góry, rower"
...
ABOUT_ID="$(create_page "o-mnie" "O mnie" "Cześć! Tu będzie krótki opis autora bloga, pasji górskich i rowerowych.")"
