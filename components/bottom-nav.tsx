...
export function BottomNav() {
  ...
  return (
    <nav
      className="relative z-50 w-full shrink-0 border-t border-border/80 bg-background pb-[max(0px,env(safe-area-inset-bottom))] shadow-[0_-12px_40px_rgba(0,0,0,0.45)]"
    ...
    >
      <div className="mx-auto flex max-w-lg items-end justify-around px-2 pt-2 pb-2">
        ...
        <Link
          ...
          className="relative -mt-8 flex h-16 w-16 items-center justify-center rounded-full bg-accent text-black shadow-glow ring-4 ring-background transition-transform active:scale-95"
